...
export function ButtonGroup(props: ComponentProps<"div"> & { orientation?: "horizontal" | "vertical" }) {
  ...
  return <div {...rest} role="group" data-slot="button-group" data-orientation={local.orientation ?? "horizontal"} classList={{ ...local.classList, [local.class ?? ""]: !!local.class }}>{local.children}</div>
}
