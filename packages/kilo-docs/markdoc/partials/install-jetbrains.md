...
{% callout type="info" %}
The v7 EAP plugin supports JetBrains IDEs with 261+ builds. EAP builds update frequently, so enable JetBrains plugin auto-update during installation to stay current. Share feedback in the JetBrains channel on the [Kilo Discord](https://kilo.ai/discord).
{% /callout %}
