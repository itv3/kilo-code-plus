...
4. You should now be able to DM the bot from Slack. You will need to add the bot to any individual channels and tell it to update it's config for any channels you want it to participate in.
