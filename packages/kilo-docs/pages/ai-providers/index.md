...
For all providers, there is a **five-minute timeout** on time to first byte. This means if a provider does not begin streaming a response within five minutes of the request being sent, the request will be cancelled. This is an intrinsic constraint of the Bun runtime and cannot be configured.
{% /callout %}
