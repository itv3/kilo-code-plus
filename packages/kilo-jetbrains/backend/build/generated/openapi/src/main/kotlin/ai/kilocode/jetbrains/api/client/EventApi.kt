...
import ai.kilocode.jetbrains.api.model.Event
...
open class EventApi(basePath: kotlin.String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
    ...
    fun eventSubscribe(directory: kotlin.String? = null, workspace: kotlin.String? = null) : Event {
    ...
    fun eventSubscribeWithHttpInfo(directory: kotlin.String?, workspace: kotlin.String?) : ApiResponse<Event?> {
