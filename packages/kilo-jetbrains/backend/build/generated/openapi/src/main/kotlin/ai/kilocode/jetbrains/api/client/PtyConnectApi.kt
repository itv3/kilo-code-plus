...
open class PtyConnectApi(basePath: kotlin.String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
    companion object {
        @JvmStatic
    ...
    fun ptyConnect(ptyID: kotlin.String, directory: kotlin.String? = null, workspace: kotlin.String? = null) : kotlin.Boolean {
        val localVarResponse = ptyConnectWithHttpInfo(ptyID = ptyID, directory = directory, workspace = workspace)
    ...
    fun ptyConnectWithHttpInfo(ptyID: kotlin.String, directory: kotlin.String?, workspace: kotlin.String?) : ApiResponse<kotlin.Boolean?> {
        val localVariableConfig = ptyConnectRequestConfig(ptyID = ptyID, directory = directory, workspace = workspace)
     ...
     */
    fun ptyConnectRequestConfig(ptyID: kotlin.String, directory: kotlin.String?, workspace: kotlin.String?) : RequestConfig<Unit> {
