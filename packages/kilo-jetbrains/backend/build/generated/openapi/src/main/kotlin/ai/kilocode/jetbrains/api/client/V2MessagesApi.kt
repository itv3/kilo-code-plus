...
import ai.kilocode.jetbrains.api.model.V2SessionMessagesResponse
...
open class V2MessagesApi(basePath: kotlin.String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
    companion object {
        @JvmStatic
    ...
    fun v2SessionMessages(sessionID: kotlin.String, directory: kotlin.String? = null, workspace: kotlin.String? = null) : V2SessionMessagesResponse {
        val localVarResponse = v2SessionMessagesWithHttpInfo(sessionID = sessionID, directory = directory, workspace = workspace)
    ...
    fun v2SessionMessagesWithHttpInfo(sessionID: kotlin.String, directory: kotlin.String?, workspace: kotlin.String?) : ApiResponse<V2SessionMessagesResponse?> {
        val localVariableConfig = v2SessionMessagesRequestConfig(sessionID = sessionID, directory = directory, workspace = workspace)

        return request<Unit, V2SessionMessagesResponse>(
            localVariableConfig
        )
    }
     ...
     */
    fun v2SessionMessagesRequestConfig(sessionID: kotlin.String, directory: kotlin.String?, workspace: kotlin.String?) : RequestConfig<Unit> {
