...
type VisibleStreamMessage = { type?: unknown; sessionID?: unknown; visible?: unknown }

function parse(message: unknown): VisibleStreamMessage | undefined {
  if (!message || typeof message !== "object") return undefined
  const msg = message as VisibleStreamMessage
