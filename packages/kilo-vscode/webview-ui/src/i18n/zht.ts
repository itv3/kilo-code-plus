...
export const dict = {
  ...
  "provider.custom.models.image.label": "支援圖片輸入",
  "provider.custom.models.contextLimit.label": "上下文 token 上限",
  "provider.custom.models.contextLimit.placeholder": "例如 128000",
  "provider.custom.models.outputLimit.label": "最大輸出 token",
  "provider.custom.models.outputLimit.placeholder": "例如 8192",
  ...
  "provider.custom.error.cost": "請輸入大於或等於 0 的數字，最多保留 2 位小數",
