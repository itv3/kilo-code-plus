...
export const dict = {
  ...
  "provider.custom.models.image.label": "Images",
  "provider.custom.models.contextLimit.label": "Context token limit",
  "provider.custom.models.contextLimit.placeholder": "e.g. 128000",
  "provider.custom.models.outputLimit.label": "Max output tokens",
  "provider.custom.models.outputLimit.placeholder": "e.g. 8192",
  ...
  "provider.custom.error.cost": "Enter a number greater than or equal to 0 with up to 2 decimal places",
